<template>
  <div class="tl pa5" @click="toggleTab">
    <h1 class="title ml6"><slot name="heading"></slot></h1>
    <span class="flex" v-show="showContent">
      <span
        v-show="template === 'default'"
        class="sans-serif ml6 pb7 pr7"
      >
        <slot></slot>
      </span>
      <ul
      ...
      >
        ...
        <a
          :href="link"
          class="lgct-red sans-serif pt2 fw4 tc"
