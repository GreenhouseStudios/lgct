  ...
  <div>
      ...
      <section class="tl mh5">
        ...
        <div class="sans-serif">
          <p class="f3">
            ...
            project to help recenter UConn’s place as a land-grant university.
            By informing UConn affiliates and building bridges with other
            land-grant institutions, we hope to add to a larger movement of
            restorative justice built around a better understanding of the
            Morrill Act and subsequent educational acts that accumulated land
            and wealth for white settlers, a legacy that is still felt into the
            present day. We aim to foster conversations and dialogues and build
      ...
      <section class="tl mh5">
        ...
        <div class="sans-serif">
          <p class="f3">
            ...
            traced the land parcels and money tied to every Land-Grant
            University in the United States. It defined the Morrill Act based on
            land and wealth accumulation and the violence backed treaties that
            helped create it. Because of its incredible depth, Glenn and Sage
            began to pivot their goals to continue building off the work the
            LandGrabU team had done.
          </p>
          <p class="f3">
            ...
            and collaboration, the current LandGrab CT website began to take
            form. The team researched, synthesised information, formulated
            theses, and designed web layouts. The goal was to create an
            interactive and engaging experience that educates viewers with a
            wider historical perspective to encourage them to interrogate their
            assumptions about land grant universities and the education system
            as a whole.
          </p>
        </div>
      </section>
    ...
    <div class="section bg-lgct-teal fw3">
      <section class="tl mh5 white">
        ...
        <div class="flex flex-wrap w-100 justify-between list ph3">
          <ul class="list serif f3">
            <li>Land Grab U - Tristan Ahtone and Bobby Lee</li>
            <li>Jiff Martin</li>
            <li>Steven Gavazzi</li>
            <li>NACP, Shaquanna Sebastian, Kiara Ruesta-Cayetano</li>
            <li>Mike Stanton</li>
          </ul>
        </div>
      </section>
